          ...
          {announcements.map((announcement) => (
            ...
            >
              <header className="flex items-start gap-3 p-4 pb-3 sm:p-5 sm:pb-3">
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-water-600 text-white">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-water-200 bg-water-50 px-2.5 py-1 text-xs font-bold text-water-700">
