export default function CurrentBalanceCard({ amountDue = 0 }) {
  ...
  return (
    <section className="ww-page-header flex min-h-44 flex-col justify-between p-5 text-white sm:p-6">
      <div>
        <h3 className="mb-1 text-xs font-bold uppercase tracking-[0.14em] text-cyan-300">
          Amount due
        </h3>
      ...
      <div className="mt-4">
        <span
          className={`ww-data-value font-mono text-3xl font-bold tracking-normal ${hasBalance ? "text-white" : "text-cyan-200"}`}
        ...
        <span className="mt-2 block text-xs font-semibold text-sky-100">
